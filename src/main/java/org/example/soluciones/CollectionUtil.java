...
public class CollectionUtil {
	 ...
	 */
	public void eliminaNombresConEspacios(List<PersonaOptional> original) {
	 ...
	 */
	public void pasarAMayusculas (List<PersonaOptional> original) {
		original.replaceAll(p -> new PersonaOptional( p.getNombre().toUpperCase(),
